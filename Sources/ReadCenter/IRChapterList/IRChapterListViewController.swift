...
enum IRSegmentType: String {
    /// 目录
    case chapter = "Contenido"
    /// 书签
    case bookmark = "Marcadores"
}
    ...
    func updateEmptyStata() {
        if (segmentType == .bookmark && bookmarkList.count == 0) {
            if emptyView == nil {
                ...
                emptyView?.setTitle("Sin marcadores", subTitle: "Abra el menú de lectura, toque el botón ”Marcador“ para agregar un marcador" )
